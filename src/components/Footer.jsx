        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <div className="mt-6 flex space-x-4">
              ...
              <a href="https://www.linkedin.com/in/jainova-lifesciences-260428405" target="_blank" rel="noopener noreferrer" className="text-white hover:text-[#a7f5ee] transition-colors duration-300">
